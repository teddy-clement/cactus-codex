  ...
  return (
    <div className="dash-shell">
      <section className="hero-shell">
        <div className="hero-card hero-card-main">
          ...
          <p className="hero-copy">
            Depuis Cactus Codex, gardez la main sur la maintenance globale, la maintenance par module,
            les messages publics, les redémarrages requis et les signaux structurels remontés par vos applications.
          </p>
          <div className="hero-actions">
            <Link href="/dashboard/apps" className="hero-btn hero-btn-primary">Contrôler {appName}</Link>
        ...
        <div className="hero-card hero-card-side">
          ...
          <div className="focus-meta">
            ...
            <div><span className="focus-key">Endpoint public</span><code>/api/public/apps/{appKey}</code></div>
          </div>
      ...
      <section className="metrics-grid">
        <div className="metric-card"><div className="metric-icon">⬡</div><div className="metric-value">{apps.length}</div><div className="metric-label">{apps.length > 1 ? 'Applications suivies' : 'Application suivie'}</div><div className="metric-sub">pilotées depuis Codex</div></div>
        ...
        <div className="metric-card"><div className="metric-icon">▲</div><div className="metric-value">{app?.uptime?.toFixed?.(1) ?? app?.uptime ?? '—'}%</div><div className="metric-label">Uptime {appName}</div><div className="metric-sub">dernière fenêtre monitorée</div></div>
      </section>
      ...
      <section className="content-grid">
        ...
        <div className="panel">
          <div className="ph"><div className="pht">Télémétrie</div><div className="phg">// structurel uniquement</div></div>
      ...
      <section className="content-grid lower-grid">
        ...
        <div className="panel">
          <div className="ph"><div className="pht">Doctrine Codex</div><div className="phg">// ligne claire</div></div>
          <div className="panel-body doctrine-list">
            <div className="doctrine-item"><span>01</span><p>Maintenance globale en un bouton, sans bricolage dans les apps clientes.</p></div>
            <div className="doctrine-item"><span>02</span><p>Maintenance ciblée par module : chaque brique pilotable individuellement.</p></div>
